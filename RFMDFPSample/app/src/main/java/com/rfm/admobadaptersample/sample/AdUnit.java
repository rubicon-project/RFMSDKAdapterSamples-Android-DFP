...
import com.rfm.admobadaptersample.FastLaneSimpleBanner;
import com.rfm.admobadaptersample.FastLaneSimpleInterstitial;
import com.rfm.admobadaptersample.SimpleBanner;
import com.rfm.admobadaptersample.SimpleInterstitial;
...
public class AdUnit implements Comparable<AdUnit> {
    ...
    enum AdType {
        ADMOB_BANNER_AD ("SimpleBanner", SimpleBanner.class),
        ADMOB_INTERSTITIAL_AD ("SimpleInterstitial", SimpleInterstitial.class),
        ADMOB_FASTLANE_BANNER_AD ("FastLaneSimpleBanner", FastLaneSimpleBanner.class),
        ADMOB_FASTLANE_INTERSTITIAL_AD ("FastLaneSimpleInterstitial", FastLaneSimpleInterstitial.class);
